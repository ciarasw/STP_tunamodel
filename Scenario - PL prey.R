...
#scenario: Objective: Sustainability of prey species
# Eg., limits to beach seining leads to increased costs of p/l fishing
...
PL_costin = 1.5 #cost increase

effort_summary$unitcost = as.vector(c(1, 22000, 2000, 100, 3000*PL_costin, #IN
                                      22000, 2000, 100, #PH
                                      1, 22000, 100, #VN
                                      1, 22000 #other
))
