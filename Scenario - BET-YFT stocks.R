...
#scenario: Objective: Rebuild BET stocks

# Scenario setup:
#decrease efforts for all gears that catch large quantities of BET & YFT (ie all gears)
...
effort_mat[,1] = 5e7*eff_red #INLL #order of gears needs to match order in Qs
effort_mat[,2] = 3000*eff_red #INPS
effort_mat[,3] = 50000*eff_red #INHL
effort_mat[,4] = 39000*eff_red #INSSS
effort_mat[,5] = 4500*eff_red #INPL
effort_mat[,6] = 4300*eff_red #PHPS
effort_mat[,7] = 45000*eff_red #PHHL
effort_mat[,8] = 10000*eff_red #PHSSS 
effort_mat[,9] = 4.59e7*eff_red #VNLL
effort_mat[,10] = 1300*eff_red #VNPS
effort_mat[,11] = 2000*eff_red #VNSSS
effort_mat[,12] = 3.23e8*eff_red #otherLL
